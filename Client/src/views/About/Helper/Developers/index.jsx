import { Flex, Box, Avatar, Link, Heading } from "@chakra-ui/react";
    ...
    <Box p="30px" bgGradient="linear(to-l,#000000, #272727)">
      ...
      <Flex flexWrap="wrap" justifyContent="center">
        <Box textAlign="center" mx={8} my={8}>
          <Avatar size="2xl" name="Jeremy" src="https://via.placeholder.com/150" mb={4} />
        ...
        <Box textAlign="center" mx={8} my={8}>
          <Avatar size="2xl" name="Aixa" src="https://via.placeholder.com/150" mb={4} />
        ...
        <Box textAlign="center" mx={8} my={8}>
          <Avatar size="2xl" name="Aixa" src="https://via.placeholder.com/150" mb={4} />
          <Box fontWeight="bold" fontSize="xl" mb={4} color="#f27825">Gonza</Box>
          <Link href="https://www.linkedin.com/" target="_blank" fontSize="lg" mr={4} color="white">LinkedIn</Link>
          <Link href="https://github.com/" target="_blank" fontSize="lg" color="white">GitHub</Link>
        </Box>
        <Box textAlign="center" mx={8} my={8}>
        ...
        <Box textAlign="center" mx={8} my={8}>
          <Avatar size="2xl" name="Aixa" src="https://via.placeholder.com/150" mb={4} />
          <Box fontWeight="bold" fontSize="xl" mb={4} color="#f27825">Nico</Box>
          <Link href="https://www.linkedin.com/" target="_blank" fontSize="lg" mr={4} color="white">LinkedIn</Link>
          <Link href="https://github.com/" target="_blank" fontSize="lg" color="white">GitHub</Link>
        </Box>
        <Box textAlign="center" mx={8} my={8}>
        ...
        <Box textAlign="center" mx={8} my={8}>
          <Avatar size="2xl" name="Aixa" src="https://via.placeholder.com/150" mb={4} />
          <Box fontWeight="bold" fontSize="xl" mb={4} color="#f27825">Joaquin</Box>
          <Link href="https://www.linkedin.com/" target="_blank" fontSize="lg" mr={4} color="white">LinkedIn</Link>
          <Link href="https://github.com/" target="_blank" fontSize="lg" color="white">GitHub</Link>
        </Box>

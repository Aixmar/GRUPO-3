    ...
    <>
      <form onSubmit={submitHandler} > 
        <section  >                        
          ...
          <input type='text' name='name' value={form.name} onChange={inputChangeHandler} placeholder='' ></input>
          {/* {errors.name && <div className={css.errors} >⚠ {errors.name}</div>} */}
        </section>

        <section>
          <label htmlFor='lastName' >Last name: </label>
          <input type='text' name='lastName' value={form.lastName} onChange={inputChangeHandler} placeholder='' ></input>

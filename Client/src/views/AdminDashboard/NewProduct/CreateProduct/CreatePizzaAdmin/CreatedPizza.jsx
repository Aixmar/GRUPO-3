        ...
        <>
            <Box width='100%' height='100%' color='black' >
                <Box display='flex' height='4rem' justifyContent='space-around' alignItems='center' >
                    <Text color='#f27825' fontSize='2.2rem' fontWeight='600' mr="230px" >New pizza..</Text>
                    {/* <Image src={cookingpizza} alt='pizza' height='8.6rem' /> */}
                </Box>

                {/* <Box w='12rem' margin='0 auto' h='12rem' borderRadius='50%' border='1px solid #545454b9' overflow='hidden' > */}
                    <Image src={form.image} w='12rem' h='12rem' objectFit='cover' borderRadius='50%'ml="20px"  border='1px solid #545454b9' />
                {/* </Box> */}

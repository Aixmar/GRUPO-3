    ...
    const loginWithGoogle = async () => {
        ...
        try {
            ...
            if (!userLogin.length) {    
                ...
                const userGoogle = { name: userName, lastName: userLastName, email: user?.email, password: user?.uid, image: user?.photoURL, birthday: '00-00-00', cart: [], rol: 'user', favorites: [], previusPurchase: [], location: {} };
